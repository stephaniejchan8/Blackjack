...
function createCard(personCards) {
    ...
    if (deck[deckIndex].suit === 'D') {
        card.innerHTML = `<p>${ deck[deckIndex].name}</p><img class='suit' src="images/diamond.png" />`;
        card.classList.add('red');
    } else if (deck[deckIndex].suit === 'H') {
        card.innerHTML = `<p>${ deck[deckIndex].name }</p><img class='suit' src="images/heart.png" />`;
        card.classList.add('red');
    } else if (deck[deckIndex].suit === 'C') {
        card.innerHTML = `<p>${ deck[deckIndex].name }</p><img class='suit' src="images/club.png" />`;
    } else {
        card.innerHTML = `<p>${ deck[deckIndex].name }</p><img class='suit' src="images/spade.png" />`;
    }
